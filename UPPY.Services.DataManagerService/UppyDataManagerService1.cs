...
namespace UPPY.Services.DataManagerService
{
    ...
    public partial class UppyDataManagerService : IUppyDataService
    {
        ...
        public List<BillInnerShift> GetDocumentsBillInnerShift(List<int> ids)
        {
            _logger.Trace("Trace method GetDocuments for document: {0}", typeof(BillInnerShift).Name);
            return _dataManagers.GetDocuments<BillInnerShift>(ids).OrderBy(x => x.Id).ToList();
        }
        ...
        public List<BillShift> GetDocumentsBillShift(List<int> ids)
        {
            _logger.Trace("Trace method GetDocuments for document: {0}", typeof(BillShift).Name);
            return _dataManagers.GetDocuments<BillShift>(ids).OrderBy(x => x.Id).ToList();
        }
        ...
        public List<ExcludeDrawing> GetDocumentsExcludeDrawing(List<int> ids)
        {
            _logger.Trace("Trace method GetDocuments for document: {0}", typeof(ExcludeDrawing).Name);
            return _dataManagers.GetDocuments<ExcludeDrawing>(ids).OrderBy(x => x.Id).ToList();
        }
        ...
        public List<Gost> GetDocumentsGost(List<int> ids)
        {
            _logger.Trace("Trace method GetDocuments for document: {0}", typeof(Gost).Name);
            return _dataManagers.GetDocuments<Gost>(ids).OrderBy(x => x.Id).ToList();
        }
        ...
        public List<Order> GetDocumentsOrder(List<int> ids)
        {
            _logger.Trace("Trace method GetDocuments for document: {0}", typeof(Order).Name);
            return _dataManagers.GetDocuments<Order>(ids).OrderBy(x => x.Id).ToList();
        }
        ...
        public List<PackingList> GetDocumentsPackingList(List<int> ids)
        {
            _logger.Trace("Trace method GetDocuments for document: {0}", typeof(PackingList).Name);
            return _dataManagers.GetDocuments<PackingList>(ids).OrderBy(x => x.Id).ToList();
        }
        ...
        public List<ProfileWorkHour> GetDocumentsProfileWorkHour(List<int> ids)
        {
            _logger.Trace("Trace method GetDocuments for document: {0}", typeof(ProfileWorkHour).Name);
            return _dataManagers.GetDocuments<ProfileWorkHour>(ids).OrderBy(x => x.Id).ToList();
        }
        ...
        public List<RateWorkHour> GetDocumentsRateWorkHour(List<int> ids)
        {
            _logger.Trace("Trace method GetDocuments for document: {0}", typeof(RateWorkHour).Name);
            return _dataManagers.GetDocuments<RateWorkHour>(ids).OrderBy(x => x.Id).ToList();
        }
        ...
        public List<Setting> GetDocumentsSetting(List<int> ids)
        {
            _logger.Trace("Trace method GetDocuments for document: {0}", typeof(Setting).Name);
            return _dataManagers.GetDocuments<Setting>(ids).OrderBy(x => x.Id).ToList();
        }
        ...
        public List<Standart> GetDocumentsStandart(List<int> ids)
        {
            _logger.Trace("Trace method GetDocuments for document: {0}", typeof(Standart).Name);
            return _dataManagers.GetDocuments<Standart>(ids).OrderBy(x => x.Id).ToList();
        }
        ...
        public List<SuperTaskToDistrict> GetDocumentsSuperTaskToDistrict(List<int> ids)
        {
            _logger.Trace("Trace method GetDocuments for document: {0}", typeof(SuperTaskToDistrict).Name);
            return _dataManagers.GetDocuments<SuperTaskToDistrict>(ids).OrderBy(x => x.Id).ToList();
        }
        ...
        public List<SuperBillInnerShift> GetDocumentsSuperBillInnerShift(List<int> ids)
        {
            _logger.Trace("Trace method GetDocuments for document: {0}", typeof(SuperBillInnerShift).Name);
            return _dataManagers.GetDocuments<SuperBillInnerShift>(ids).OrderBy(x => x.Id).ToList();
        }
        ...
        public List<SuperBillShift> GetDocumentsSuperBillShift(List<int> ids)
        {
            _logger.Trace("Trace method GetDocuments for document: {0}", typeof(SuperBillShift).Name);
            return _dataManagers.GetDocuments<SuperBillShift>(ids).OrderBy(x => x.Id).ToList();
        }
        ...
        public List<TaskToDistrict> GetDocumentsTaskToDistrict(List<int> ids)
        {
            _logger.Trace("Trace method GetDocuments for document: {0}", typeof(TaskToDistrict).Name);
            return _dataManagers.GetDocuments<TaskToDistrict>(ids).OrderBy(x => x.Id).ToList();
        }
        ...
        public List<GangTaskToDistrict> GetDocumentsGangTaskToDistrict(List<int> ids)
        {
            _logger.Trace("Trace method GetDocuments for document: {0}", typeof(GangTaskToDistrict).Name);
            return _dataManagers.GetDocuments<GangTaskToDistrict>(ids).OrderBy(x => x.Id).ToList();
        }
        ...
        public List<TechOperation> GetDocumentsTechOperation(List<int> ids)
        {
            _logger.Trace("Trace method GetDocuments for document: {0}", typeof(TechOperation).Name);
            return _dataManagers.GetDocuments<TechOperation>(ids).OrderBy(x => x.Id).ToList();
        }
        ...
        public List<TechRoute> GetDocumentsTechRoute(List<int> ids)
        {
            _logger.Trace("Trace method GetDocuments for document: {0}", typeof(TechRoute).Name);
            return _dataManagers.GetDocuments<TechRoute>(ids).OrderBy(x => x.Id).ToList();
        }
        ...
        public List<WorkHourStandartDrawing> GetDocumentsWorkHourStandartDrawing(List<int> ids)
        {
            _logger.Trace("Trace method GetDocuments for document: {0}", typeof(WorkHourStandartDrawing).Name);
            return _dataManagers.GetDocuments<WorkHourStandartDrawing>(ids).OrderBy(x => x.Id).ToList();
        }
        ...
        public List<WorkHourDrawing> GetDocumentsWorkHourDrawing(List<int> ids)
        {
            _logger.Trace("Trace method GetDocuments for document: {0}", typeof(WorkHourDrawing).Name);
            return _dataManagers.GetDocuments<WorkHourDrawing>(ids).OrderBy(x => x.Id).ToList();
        }
        ...
        public List<InstrumentTechOperation> GetDocumentsInstrumentTechOperation(List<int> ids)
        {
            _logger.Trace("Trace method GetDocuments for document: {0}", typeof(InstrumentTechOperation).Name);
            return _dataManagers.GetDocuments<InstrumentTechOperation>(ids).OrderBy(x => x.Id).ToList();
        }
        ...
        #region SuperStandart

        public List<SuperStandart> GetListSuperStandart()
        {
            _logger.Trace("Trace method GetList for document: {0}", typeof(SuperStandart).Name);
            return _dataManagers.GetListCollection<SuperStandart>().OrderBy(x => x.Id).ToList();
        }

        public List<SuperStandart> GetDocumentsSuperStandart(List<int> ids)
        {
            _logger.Trace("Trace method GetDocuments for document: {0}", typeof(SuperStandart).Name);
            return _dataManagers.GetDocuments<SuperStandart>(ids).OrderBy(x => x.Id).ToList();
        }

        public List<HistoryRecord<SuperStandart>> GetHistoryDocSuperStandart(SuperStandart doc)
        {
            _logger.Trace("Trace method GetHistoryList for document: {0}", typeof(SuperStandart).Name);
            return _historyManager.GetHistoryDoc(doc);
        }

        public SuperStandart GetDocumentSuperStandart(int id)
        {
            _logger.Trace("Trace method GetDocument for document: {0}. Id: {1}", typeof(SuperStandart).Name, id);
            return _dataManagers.GetDocument<SuperStandart>(id);
        }
        ...
        public SuperStandart UpdateSuperStandart(TicketAutUser ticket, SuperStandart doc)
        {
            _logger.Trace("Trace method Update for document: {0}. Id: {2}. User: {1}", typeof(SuperStandart).Name, ticket, doc.Id);
            _dataManagers.Update(doc, ticket);
            return doc;
        }
