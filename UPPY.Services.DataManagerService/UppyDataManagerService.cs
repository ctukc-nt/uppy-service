...
namespace UPPY.Services.DataManagerService
{
    ...
    public partial class UppyDataManagerService : IUppyDataService
    {
        ...
        {
            _logger.Trace("Trace method GetContainsIdListDrawing for document: {0}", typeof(Drawing).Name);
        ...
        {
            _logger.Trace("Trace method GetChildrensForIdListDrawing for document: {0}", typeof(Drawing).Name);
